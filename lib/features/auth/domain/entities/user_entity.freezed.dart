...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String emailId, String name});
}
...
class _$UserEntityImpl with DiagnosticableTreeMixin implements _UserEntity {
  const _$UserEntityImpl(
      {required this.id, required this.emailId, required this.name});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserEntity(id: $id, emailId: $emailId, name: $name)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, emailId, name);
